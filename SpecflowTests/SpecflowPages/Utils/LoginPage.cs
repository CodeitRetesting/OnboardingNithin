  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("/html/body/div[2]/div/div/div[1]/div/div[1]/input")).SendKeys("codeitretesting@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("/html/body/div[2]/div/div/div[1]/div/div[2]/input")).SendKeys("SuperTest101");
            Thread.Sleep(1000);
